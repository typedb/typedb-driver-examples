...
class GithubMigration {
    ...
    private val SCHEMA_PATH_STRING = "schemas/github.tql"
    ...
    private fun initialiseInputs() : Collection<Input> {
        ...
        // File layout:
        // datasets/reponame.json
        // datasets/reponame-users.json
        // datasets/reponame-files.json
        // datasets/reponame-commits.json
        // We could do this all in one file, 
