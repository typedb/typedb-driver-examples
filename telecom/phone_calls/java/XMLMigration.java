...
public class XMLMigration {
    ...
    public static void main(String[] args) throws FileNotFoundException, XMLStreamException {
        String databaseName = (args[0] != null) ? args[0] : "telecom/phone_calls";
    ...
    static Collection<Input> initialiseInputs() {
        ...
        inputs.add(new Input("telecom/phone_calls/data/companies", "company") {
            @Override
        ...
        inputs.add(new Input("telecom/phone_calls/data/people", "person") {
            @Override
        ...
        inputs.add(new Input("telecom/phone_calls/data/contracts", "contract") {
            @Override
        ...
        inputs.add(new Input("telecom/phone_calls/data/calls", "call") {
            @Override
