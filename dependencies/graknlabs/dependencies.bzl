...
def graknlabs_client_python():
    git_repository(
        ...
        commit = "92b80bb588043681a79fc9050b8bcf5df0f95bd5" # sync-marker: do not remove this comment, this is used for sync-dependencies by @graknlabs_client_python
    )
...
def graknlabs_client_nodejs():
    git_repository(
        ...
        commit = 'ea714b7e04099a8860795862f3e841a9542bbb3a' # sync-marker: do not remove this comment, this is used for sync-dependencies by @graknlabs_client_nodejs
    )
