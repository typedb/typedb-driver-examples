...
def graknlabs_client_python():
    git_repository(
        ...
        commit = "78d0263f386b661f9502dace6eb25827269ba2b5" # sync-marker: do not remove this comment, this is used for sync-dependencies by @graknlabs_client_python
    )
...
def graknlabs_client_nodejs():
    git_repository(
        ...
        commit = "61625ed7f310696ace5b0e895faf8e5e74d498d7" # sync-marker: do not remove this comment, this is used for sync-dependencies by @graknlabs_client_nodejs
    )
